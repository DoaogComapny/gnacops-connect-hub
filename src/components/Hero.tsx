      ...
      <div className="absolute bottom-0 left-0 right-0 z-20 pb-20 px-4">
        <div className="container mx-auto max-w-4xl text-center space-y-8">
          <h1 className="text-5xl md:text-7xl font-bold leading-tight animate-fade-in-up">
            <span className="text-gradient-primary">Join Ghana's</span>
            <br />
            <span className="text-gradient-accent">Private School Council</span>
            <br />
            <span className="text-foreground">Today</span>
          </h1>

          <p className="text-xl md:text-2xl text-muted-foreground animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
            Empowering Excellence in Private Education Across Ghana
          </p>
